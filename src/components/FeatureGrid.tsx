        ...
        <section className="py-24 px-4 bg-[var(--background)]">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-4xl md:text-5xl font-bold text-[var(--foreground)]">Future AI Tools</h2>
                    <p className="text-[var(--foreground)]/60 max-w-xl mx-auto">Experiment with the next generation of artificial intelligence interfaces.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="mb-6 p-3 w-fit rounded-lg bg-[var(--foreground)]/5 group-hover:bg-[var(--foreground)]/10 transition-colors">
                                {feature.icon}
                            </div>
                            <h3 className="text-xl font-bold text-[var(--foreground)] mb-4">{feature.title}</h3>
                            <p className="text-[var(--foreground)]/50 text-sm leading-relaxed">{feature.description}</p>
